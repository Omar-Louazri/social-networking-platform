        ...
        var defaults = {
            ...
            templates:          {
                ...
                listItem:         '<li class="mentiony-item" data-item-id="">' +
                                  '<div class="cont_">' +
                                  '<div class="img_c">' +
                                  '<img src="assets/loadings/no_avatar.png">' +
                                  '</div>' +
                                  '<div class="info_c">' +
                ...
                highlightContent: '<a href="[HREF]" data-item-id="[ITEM_ID]" class="mentiony-link">_@[TEXT]</a>',
            }
        };
    ...
    var MentionsInput = function (settings) {
        ...
        function initTextArea(ele) {
            ...
            if (settings.applyInitialSize) {
                ...
                elmInputBoxContainer.css({width: 'auto'});
